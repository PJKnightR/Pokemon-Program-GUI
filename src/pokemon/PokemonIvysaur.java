...
public class PokemonIvysaur extends Pokemon{
    ...
    public PokemonIvysaur(int lev){
        ...
        attLevel = new int[]{0, 3, 7, 9, 13, 13, 15, 20, 23, 28, 31, 36, 39, 44};
        atts = new Attack[]{new AttackTackle(), new AttackGrowl(), new AttackLeechSeed(), new AttackVineWhip(), new AttackPoisonPowder(), new AttackSleepPowder(), new AttackTakeDown(), new AttackRazorLeaf(), new AttackWingAttack(),new AttackSweetScent(), new AttackGrowth(), new AttackDoubleEdge(), new AttackWorrySeed(), new AttackSynthesis(), new AttackSolarbeam()};
