...
public class PokemonSpearow extends Pokemon{
    public PokemonSpearow(int lev){
        ...
        attLevel = new int[]{0, 0, 4, 8, 11, 15, 18, 22, 25, 29, 32, 36};
        atts = new Attack[]{new AttackPeck(), new AttackGrowl(), new AttackLeer(), new AttackPursuit(), new AttackFuryAttack(), new AttackAerialAce(), new AttackMirrorMove(), new AttackAssurance(), new AttackAgility(), new AttackSuckerPunch(), new AttackFocusEnergy(), new AttackRoost(), new AttackDrillPeck()};
